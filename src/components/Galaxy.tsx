...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    let mouseLeaveTimeoutId: NodeJS.Timeout | null = null;
    ...
    // Debounced mouse move handler to reduce reflow
    ...
    function handleMouseLeave() {
      ...
      // Fade out mouse interaction over time instead of instant off
    ...
    intersectionObserverRef.current.observe(ctn);
